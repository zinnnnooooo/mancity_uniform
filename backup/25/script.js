...
async function loadMarkingGuidePage() {
  ...
  try {
    ...
    // 부모를 유지하며 바인딩할 수 있도록 유연하게 타겟팅
    const guideContent = doc.querySelector('.app-frame') || doc.body;
    ...
    setTimeout(() => {
      mobilePageContent.innerHTML = guideContent.innerHTML;
