...
function initCartPage() {
  ...
  function renderList() {
    if (!cartItems || cartItems.length === 0) {
      cartListEl.innerHTML = `
        <div class="cart-empty" style="padding: 80px 20px; text-align: center; color: rgba(255,255,255,0.4); font-size: 14px;">
  ...
  if (btnCheckout) {
    btnCheckout.onclick = function () {
      ...
      alert(`총 ${checkedItems.length}개의 상품 구매가 완료되었습니다.`);
    };
  }
